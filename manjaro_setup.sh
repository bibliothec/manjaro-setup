...
sudo pacman -S --noconfirm noto-fonts-cjk ttf-ibm-plex ttf-linux-libertine otf-ipaexfont plasma-wayland-session sudo pacman -S $(pacman -Qsq "^linux" | grep "^linux[0-9]*[-rt]*$" | awk '{print $1"-headers"}' ORS=' ')
