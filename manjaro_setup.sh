...
yay -S --noconfirm olive zrythm rpcs3-bin yuzu-mainline-bin scilab-bin vita3k-git google-chrome local-by-flywheel-bin aptpac vmware-workstation webex-bin prospect-mail-bin ros-melodic-desktop-full xemu microchip-mplabx-bin microchip-mplabxc8-bin microchip-mplabxc16-bin microchip-mplabxc32-bin qucs-s logisim-evolution-bin unityhub teams-insiders armorpaint-git virtualbox-ext-oracle storyboarder magicavoxel famistudio-bin pixelorama man-pages-ja powershell-bin meshroom-bin waydroid waydroid-image boost-note-bin debtap ltspice o3de-bin material-maker-bin natron-bin ni-visa skypeforlinux-stable-bin flutter imagej dxvk-bin paru voicevox-appimage subtitlecomposer fritzing anbox-modules-dkms

# android-studio gvim-gtk2 unreal-engine epsxe citra-qt-bin youtube-dl-gui-git  github-desktop genymotion duckstation-git rstudio-desktop-daily-bin mujoco-bin davinci-resolve openfoam-org opensimulator openmodelica mitsuba3-git reaper-bin  freefilesync-bin  ttf-times-new-roman ttf-mona chrome-remote-desktop stacer bsnes m64p  cytoscape darling joplin　 vivado eclipse-java  quartus-free unity-editor-vrchat  bottles heroic-games-launcher-bin makehuman
